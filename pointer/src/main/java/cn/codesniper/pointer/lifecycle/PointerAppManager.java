 ...
 * activity堆栈式管理
 */
public class PointerAppManager {

    public static Stack<Activity> activityStack;
    public static Stack<Fragment> fragmentStack;
    public static PointerAppManager instance;

    private PointerAppManager() {
    }
     ...
     * @return AppManager
     */
    public static PointerAppManager getAppManager() {
        if (instance == null) {
            instance = new PointerAppManager();
        }
        return instance;
    }
     ...
     * 结束所有Activity
     */
    public void finishAllActivityExcept(Class clz) {
        for (int i = 0, size = activityStack.size(); i < size; i++) {
            if (null != activityStack.get(i)) {
